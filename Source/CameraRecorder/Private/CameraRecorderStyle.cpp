...
TSharedPtr<FSlateStyleSet> FCameraRecorderStyle::StyleInstance = nullptr;

void FCameraRecorderStyle::Initialize()
{
...
void FCameraRecorderStyle::Shutdown()
{
...
FName FCameraRecorderStyle::GetStyleSetName()
{
	static FName StyleSetName(TEXT("CameraRecorderStyle"));
	return StyleSetName;
}
...
void FCameraRecorderStyle::ReloadTextures()
{
...
const ISlateStyle& FCameraRecorderStyle::Get()
{
